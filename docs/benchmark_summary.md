...
For the current **gradient-only** comparison, including TTK in 2D/3D and
RK/PLS/F-Max in higher dimensions, see the [PLS key-storage study](pls_key_arena_benchmark.md).
